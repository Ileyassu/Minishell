...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/19 20:26:35 by ibenaiss          #+#    #+#             */
...
void	execute_rdr_input_cmd(t_parse_node *node, t_out_in_file *file)
{
	int	pid;
...
int	get_input_file(t_parse_node *node, t_rdr_node *head, t_out_in_file *file)
{
